...
$string['config_citations_choice_help'] = 'Se l\'assistente cita le fonti direttamente nel testo della risposta (es. [1]), con il titolo della fonte visibile al passaggio del mouse. "Eredita" usa il default del namespace (disattivo).';
